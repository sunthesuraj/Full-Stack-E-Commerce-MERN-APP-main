    ...
    /*const handleCheckboxChange = (event) => {
        ...
        setData((prevState) => ({
          ...
          deliveryOptions: checked
            ? [...prevState.deliveryOptions, value]
            : prevState.deliveryOptions.filter((option) => option !== value),
        }));
    };*/


  return (
    <section className='fixed top-0 bottom-0 left-0 right-0 min-w-[75vw] p-4 z-50 bg-neutral-800 bg-opacity-60 flex items-center justify-center'>
