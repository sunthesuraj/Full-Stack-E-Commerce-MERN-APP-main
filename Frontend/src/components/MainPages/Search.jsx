...
const Search = () => {
  ...
  return (
    <div className='w-full  min-w-[300px] lg:min-w-[500px] h-11 lg:h-10 rounded-lg border overflow-hidden flex items-center text-neutral-500 bg-slate-50 group focus-within:border-primary-200 '>
        <div>
            {
