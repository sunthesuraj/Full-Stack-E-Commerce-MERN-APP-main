...
import ProductCardAdmin from '../../components/AdminDashboard/ProductCardAdmin'
  ...
  return (
    <section className='p-0'>
        <div className='p-2  bg-white shadow-md flex items-center justify-between gap-4'>
                <h2 className='heading px-4'>Product</h2>
                <div className='h-full min-w-24 max-w-56 w-full ml-auto bg-blue-50 px-4 flex items-center gap-3 py-2 rounded  border focus-within:border-secondaryColor'>
