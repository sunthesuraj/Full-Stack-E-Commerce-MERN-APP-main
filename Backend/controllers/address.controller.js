...
// Function to retrieve all addresses for a user
...
// Function to update an existing address for a user
...
// Function to logically delete an address for a user (updates status)
